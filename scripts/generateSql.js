...
const rls = fs.readFileSync('prisma/sql/enable_rls.sql', 'utf8');
...
const full = schema + '\n\n-- RLS Policies\n' + rls + '\n\n-- Seed Data\n' + seed;
fs.writeFileSync('prisma/init_supabase.sql', full, 'utf8');
console.log('Successfully wrote prisma/init_supabase.sql! Total size:', full.length);
